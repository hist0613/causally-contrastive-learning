...
END
MODEL_PATH="checkpoints/CFNLI/triplets_automated_averaged_gradient_LM_dropout_05_flip_1word_augmented_1x_output_scheduling_warmup_lambda_01_try2"
TRAIN_DATASET="dataset/CFNLI/triplets_automated_averaged_gradient_LM_dropout_05_flip_1word_augmented_1x_cfnli/"
echo "================================"
echo "LM-based, lambda 0.1 try2"
echo "================================"
for i in "0" "1" "2"
do
CUDA_VISIBLE_DEVICES=0,1,2 python train_bert_imdb_pairwise_shellscript.py \
...
MODEL_PATH="checkpoints/CFNLI/triplets_automated_averaged_gradient_LM_dropout_05_flip_1word_augmented_1x_output_scheduling_warmup_lambda_03"
TRAIN_DATASET="dataset/CFNLI/triplets_automated_averaged_gradient_LM_dropout_05_flip_1word_augmented_1x_cfnli/"
echo "================================"
...
MODEL_PATH="checkpoints/CFNLI/triplets_automated_averaged_gradient_LM_dropout_05_flip_1word_augmented_1x_output_scheduling_warmup_lambda_05"
TRAIN_DATASET="dataset/CFNLI/triplets_automated_averaged_gradient_LM_dropout_05_flip_1word_augmented_1x_cfnli/"
echo "================================"
...
MODEL_PATH="checkpoints/CFNLI/triplets_automated_averaged_gradient_LM_dropout_05_flip_1word_augmented_1x_output_scheduling_warmup_lambda_07"
TRAIN_DATASET="dataset/CFNLI/triplets_automated_averaged_gradient_LM_dropout_05_flip_1word_augmented_1x_cfnli/"
echo "================================"
...
MODEL_PATH="checkpoints/CFNLI/triplets_automated_averaged_gradient_LM_dropout_05_flip_1word_augmented_1x_output_scheduling_warmup_lambda_1"
TRAIN_DATASET="dataset/CFNLI/triplets_automated_averaged_gradient_LM_dropout_05_flip_1word_augmented_1x_cfnli/"
echo "================================"
