...
echo "Lambda 0.3"
echo "------------------"
MODEL_NAME="triplet_automated_averaged_gradient_1word_augmented_1x_output_scheduling_warmup_lambda_03"
for i in "0" "1" "2"
do
CUDA_VISIBLE_DEVICES=1 python train_bert_imdb_pairwise_shellscript.py \
...
for i in "0" "1" "2"
do
CUDA_VISIBLE_DEVICES=1 python evaluate_bert_imdb_pairwise_shellscript.py \
