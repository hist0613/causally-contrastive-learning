...
MODEL_PATH="checkpoints/MultiNLI_telephone/triplets_automated_averaged_gradient_LM_dropout_05_flip_sep_noneutral_ver2_1word_augmented_1x_output_scheduling_warmup_lambda_01"
TRAIN_DATASET="dataset/MultiNLI_telephone/triplets_automated_averaged_gradient_LM_dropout_05_flip_sep_noneutral_ver2_1word_augmented_1x_mnli/"

echo "================================"
echo "LM dropoout 0.5 Flip, sep, no_neutral, ver2"
echo "================================"
for i in "0" "1" "2"
do
CUDA_VISIBLE_DEVICES=0,1,2 python train_bert_imdb_pairwise_shellscript.py \
